...
export const ServerChannel = ({
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "group px-2 py-2 rounded-md flex items-center gap-x-2 w-full mb-1 hover:bg-zinc-700/10 dark:hover:bg-zinc-700/50 transition p-2",
    ...
    >
      ...
      {channel.name === "general" && (
        <Lock className="ml-auto w-4 h-4 text-zinc-500 dark:text-zinc-400 opacity-0 group-hover:opacity-100 transition" />
      )}
